...
public class CheckUnCheck2 {
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			System.out.println("Você está tentando dividir por zero! Isso não esté certo!");
		} catch (ArrayIndexOutOfBoundsException e) {
			System.out.println("Você está tentando acessar um índice que não está no array!");
		} finally {
			System.out.println("Este código está no bloco finally. Ele náo depende se uma exceção ocorrer ou não. ");
		}
	}
